        ...
        <div>
            ...
            {projects.map(project => {
                ...
                <div className="project-container">
                    <div data-aos="flip-right" data-aos-duration="3500" data-aos-delay="200" className="img-col">
                        <a href={project.github} target="_blank" rel="noopener noreferrer">
                            <img alt="project" src={require(`./assets/images/${project.image}`)}/>
                        </a>
                    </div>
                    <div data-aos="flip-left" data-aos-duration="3500" data-aos-delay="650" className="text-col">
