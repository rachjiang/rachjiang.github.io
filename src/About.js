        ...
        <section id="about">
            <div className="container bg-linen">
                ...
                <div className="skills" data-aos="flip-down" data-aos-duration="3500" data-aos-delay="500">
                    <p className="font-bold text-2xl mt-10 py-8">Skills</p>
                    ...
                    <button className="px-6 py-2 mb-16 font-semibold border-4 bg-sapphire rounded-full border-sapphire hover:bg-blue hover:border-blue text-white text-center"><a href={pdf} target="_blank" rel="noopener noreferrer">Resume</a></button>
                </div>
                <div className="about-content">
